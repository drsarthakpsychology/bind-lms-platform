...
export const DRAFT_FDA: DrugDraft[] = [
  ...
  // CLOZAPINE — start 12.5, target 150–225, max 450; blood-level based.
  {
    ...
    bands: [
      ...
      { band_order: 2, band_type: "therapeutic", range_low: 150, range_high: 225, unit: "mg", band_label: "Target range",
        frequency: "twice daily", primary_purpose: "Target dosage", secondary_purposes: [], is_typical_starting: false, is_standard_maintenance: true,
        why_this_dose: "Increase 25–50 mg/day to a target; may rise by up to 100 mg once/twice weekly.",
        source_ref: { value: "target 150–225 mg twice daily; max 450 mg twice daily", source_id: FDA, page_ref: "FDA label", snippet: "achieve a target dosage of 150 mg to 225 mg twice per day ... Maximum dosage is 450 mg twice daily", agreement: "single" }, side_effects: [], observation_prompts: [] },
      { band_order: 3, band_type: "maximum", range_low: 450, range_high: 450, unit: "mg", band_label: "Maximum dose",
        frequency: "twice daily", primary_purpose: "Upper limit", secondary_purposes: [], is_typical_starting: false, is_standard_maintenance: false,
        source_ref: { value: "max 450 mg twice daily", source_id: FDA, page_ref: "FDA label", snippet: "Maximum dosage is 450 mg twice daily", agreement: "single" }, side_effects: [], observation_prompts: [] },
    ],
  },
